...
describe Admin::PeopleController, :type => :controller do
  ...
  describe 'GET index' do
    it 'assigns all people as @people' do
      ...
      expect(assigns(:people).to_a).to eq([person])
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      ...
      it 'redirects to the created admin_person' do
        post :create, {:person => valid_attributes}, valid_session
        expect(response).to redirect_to([:admin, Person.last])
      end
    end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      it 'updates the requested admin_person' do
        ...
        expect_any_instance_of(Person).to receive(:update).with({ 'these' => 'params'})
      ...
      it 'redirects to the admin_person' do
        person = Person.create! valid_attributes
        put :update, {:id => person.to_param, :person => valid_attributes}, valid_session
        expect(response).to redirect_to([:admin, person])
      end
    end
